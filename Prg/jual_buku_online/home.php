    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="color:#fff; font-size:30px;">Elexmedia<b>EMK</b></a>
        </div>
    ...
    <div class="jumbotron">
     ...
     <img src="img/book.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px;">
        <h2><b>Toko Buku Online.<h1>Elexmedia<b>elexmedia.co.id</b></h1></h2>
