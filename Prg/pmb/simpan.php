...
$query = mysql_query("insert into daftar values('','$email','$password','$prodi','$nama_lengkap','$tempat_lahir','$tgl_lahir','$gender','$alamat_lengkap','$agama','$nama_ayah','$nama_ibu','$alamat_ortu','$pekerjaan_ayah','$pekerjaan_ibu','$status')") or die(mysql_error());
if($query){
