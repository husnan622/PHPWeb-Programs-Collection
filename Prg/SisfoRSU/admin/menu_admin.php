												...
												<div class='tab-content'>
													...
													<div class='tab-pane fade' id='profile'>
														<blockquote>
															...
															<tr><td align='left'>Nama Pembuat</td><td>: Yuniar Supardi</td></tr>
															<tr><td align='left'>Alamat</td><td>: Sukabumi</td></tr>
															</table>
														</blockquote>
													</div>
													<div class='tab-pane fade' id='messages'>
														...
														Hai..<p>
														Selamat Datang di Sistem Informasi Rumah Sakit, aplikasi <p>
														Semoga aplikasi ini bermanfaat.<p>
														Terimakasih...<p>
													</div>
       ...
       <!-- <li><a href='#kontak' data-toggle='tab'>Kontak</a></li>
		<div class='tab-pane fade' id='kontak'>
														...
														<img src='../img/fb.png' class='img-responsive' alt='Inbox Facebook'/></a></td><td> Elexmedia Komputindo</td></tr>
														<tr><td><a href='http://twitter.com/'>
														<img src='../img/tw.png' class='img-responsive' alt='Inbox Facebook'/></a></td><td> @elexmedia</td></tr>
														<tr><td>
