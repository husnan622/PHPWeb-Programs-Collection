...
<html lang="en">
  <head>
    ...
    <title>Elexmedia Komutindo</title>
    ...
    <div class="jumbotron">
     ...
     <img src="img/buku31.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Toko Buku Online<h1 style="color:#f97b61;"><b>elexmedia.co.id</b></h1></h2>
        <p>Berbelanja Mudah Dan Murah</p>
      </div>
    </div>
    </div>
...
Cara Pesan
      ...
      <div class="row" style="margin:20px;">
		<p><h3><b>1. Pembayaran dilakukan dalam jangka waktu 1x24 jam setelah melakukan pemesanan.<br>
          ...
          <br>
		<p style="color:#0000ff;">Yuniar Supardi,
		BNI Syariah Jakarta,
		No Rek 00112233</p>
		<br>
   ...
   <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      ...
      <div style="margin:50px;height:120px;">
        ...
        <ul>
          ...
          <li>Cara berbelanja Dengan Mudah dan Murah</li>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <ul>
          ...
          <ul>
          <li>Jl.Palmerah Barat 29-37</li>
          <li>Jakarta</li>
          <li>Kodepos 10270, Indonesia</li>
          <li></li>
        </ul>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <center>&copy; 2020 Elexmedia komputindo</center>
        </div>
      </div>
  </body>
</html>
