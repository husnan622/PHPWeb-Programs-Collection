...
<html lang="en">
  <head>
    ...
    <title>Elexmedia Komputindo Online</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><img src="images/header.jpg" style="width:150px; margin-top: -7px;"></a>
        </div>
...
<li class="a"><a href="LaporanPenjualan.php" style="color:#fff;"><span class="glyphicon glyphicon-question-sign"> Laporan Penjualan| </span></a></li>
    ...
    <div class="jumbotron">
     ...
     <img src="img/buku31.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Toko Buku Online Elexmedia Komputindo<h1 style="color:#f97b61;"><b>elexmedia.co.id</b></h1></h2>
        <p>Membeli Buku Dengan Cara Mudah dan Murah</p>
      </div>
    </div>
    </div>
...
<b>Buku Kami</b>
    ...
    <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      <div class="row" style="background:#CC0099">
      <div class="col-md-4">
      <div style="margin:50px;height:120px;">
        <center>
        <ul>
          <li style="color:#f97b61"><h3><b>Tentang elexmedia</b></h3></li>
        </ul></center>
          <hr>
        <ul>
          <li><b>elexmedia</b> adalah</li>
          <li>Penerbit Dan Penjualan buku online</li>
          <li>yang menyediakan berbagai buku bacaan</li>
          <li>Pemesanan Dengan Memilih Kategori Buku</li>
        </ul>
      </div>
      </div>
      <div class="col-md-4">
      <div style="margin:50px;height:120px;">
        ...
        <ul>
          ...
          <ul>
          <li>Jl.  Palmerah Barat No. 29-37</li>
          <li>Jakarta </li>
          <li>kodepos 10270</li>
          </ul>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <center>
          &copy; 2020 Elexmedia Komputindo.
        </center>
        </div>
      </div>
  </body>
